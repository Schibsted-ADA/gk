...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  FooReply Foo(FooRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := test_thrift.NewTestThriftServiceClientFactory(trans, protocolFactory)
  ...
  case "Foo":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Foo requires 1 args")
      flag.Usage()
    }
    arg4 := flag.Arg(1)
    ...
    argvalue0 := test_thrift.NewFooRequest()
